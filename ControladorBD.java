...
public class ControladorBD {
    ...
    private ControladorBD() {
        this.bbdd = "examen"; // Nombre de la base de datos en SQLite es el fichero
        this.usuario = "root";
        this.clave = "";
        //this.usuario = "trasslink"; // No tenemos en SQLite
     //this.clave = "Odio@Jo$€LuI$2019"; // No tenemos en SQLite
        this.servidor = ""; // Ip del servidor en MySQL o MariaDB. Cualquier Ip
    ...
    public void abrirBD() {
        ...
        try {
          ...
          // conexion= DriverManager.getConnection("jdbc:mariadb://localhost:3306/trasslink?useUnicode=true&passwordCharacterEncoding=UTF-8", "trasslink", "Odio@Jo$€LuI$2019");
